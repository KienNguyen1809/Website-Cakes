			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> BKAV - Ban AN NINH MẠNG </a></li>
						<li><a href=""><i class="fa fa-phone"></i> 0166 364 1140</a></li>
					</ul>
				</div>
				<div class="pull-right auto-width-right">
					<ul class="top-details menu-beta l-inline">
					@if(Auth::check())
						<li><a href="">Xin chào bạn {{Auth::user()->full_name}}</a></li>
