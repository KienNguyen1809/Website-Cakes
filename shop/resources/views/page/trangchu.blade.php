...
<div class="fullwidthbanner-container">
	<div class="fullwidthbanner">
	    ...
	    <div class="banner" >
				<ul>
				@foreach($slide as $sl)
				<!-- src="source/image/slide/{{$sl->image}}" :	$slide là $sl trỏ đến cột image trong bảng slide của database db_banhang -->
					<!-- THE FIRST SLIDE -->
				...
				<div class="row">
					<div class="col-sm-12">
								...
								<div class="col-sm-3">
									...
									@endif
										...
										<div class="single-item-caption">
											...
											<!-- Parameter Tham số dùng mảng nên khi thêm id và số lượng sản phẩm mới, ta cho chúng vào 1 mảng [$new->id, '1'] -->
						...
						<div class="beta-products-list">
							...
							<div class="beta-products-details">
								<p class="pull-left"><i>Tìm thấy {{count($sanpham_khuyenmai)}} sản phẩm</i></p>
								<div class="clearfix"></div>
							</div>
							<div class="row">
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-caption">
											...
											<!-- Parameter Tham số dùng mảng nên khi thêm id và số lượng sản phẩm khuyến mại, ta cho chúng vào 1 mảng [$spkm->id, '1'] -->
											<a class="add-to-cart pull-left" href="{{route('themgiohang',[$spkm->id, '1'])}}"><i class="fa fa-shopping-cart"></i></a>
