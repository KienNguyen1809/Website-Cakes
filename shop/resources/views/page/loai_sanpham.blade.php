...
<div class="inner-header">
		<div class="container">
			<div class="pull-left">
				<h3 class="inner-title"><strong>Sản phẩm {{$loap_sp->name}}</strong></h3>
			</div>
		...
		<div class="main-content">
			...
			<div class="row">
				<div class="col-sm-3">
					<ul class="aside-menu">
					@foreach($loai as $l)
						<li><a href="{{route('loaisanpham',$l->id)}}"><h5>{{$l->name}}</h5></a></li>
					@endforeach
					</ul>
				</div>
				<div class="col-sm-9">
					<div class="beta-products-list">
						...
						<div class="beta-products-details">
							<p class="pull-left"><i>Tìm thấy {{count($sp_theoloai)}} sản phẩm</i></p>
							<div class="clearfix"></div>
						</div>
							...
							<div class="col-sm-4">
								<div class="single-item">
									...
									<div class="single-item-caption">
										...
										<a class="add-to-cart pull-left" href="{{route('themgiohang',[$sp->id, '1'])}}"><i class="fa fa-shopping-cart"></i></a>
					...
					<div class="beta-products-list">
						<h4><i>Sản phẩm khác</i></h4>
						<div class="beta-products-details">
							<p class="pull-left"><i>Tìm thấy {{count($sp_khac)}} sản phẩm</i></p>
							<div class="clearfix"></div>
						</div>
							...
							<div class="col-sm-4">
								<div class="single-item">
									...
									<div class="single-item-caption">
										...
										<!-- Parameter Tham số dùng mảng nên khi thêm id và số lượng sản phẩm khác, ta cho chúng vào 1 mảng [$sptt->id, '1'] -->
										<a class="add-to-cart pull-left" href="{{route('themgiohang',[$sp_k->id, '1'])}}"><i class="fa fa-shopping-cart"></i></a>
